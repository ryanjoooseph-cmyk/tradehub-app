    ...
    <div className="space-y-5">
      ...
      <div className="rounded-2xl border bg-card/40 overflow-hidden">
        ...
        {Array.from({ length: 10 }).map((_, i) => {
          const jobId = 1042 + i;
          return (
            <div key={jobId} className="grid grid-cols-12 px-4 py-3 border-b last:border-b-0 hover:bg-accent/20 transition">
              <div className="col-span-3">
                <Link className="font-medium hover:underline" href={`/app/jobs/${jobId}`}>JB-{jobId}</Link>
