...
- **File: `/src/components/DisputeStatusFilter.js`**
  ...
  - Handle filter changes and trigger re-fetching of disputes.
...
- Write component tests for UI components in `/src/components/AdminDisputesTable.test.js`, `/src/components/DisputeStatusFilter.test.js`, and `/src/components/UpdateStatusButton.test.js`.
